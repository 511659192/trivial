...
public class MessagePackExample {
	...
	public static void basicUsage() throws IOException {
		...
		// MessageBufferPacker is an optimized version of MessagePacker for
	...
	public static void packer() throws IOException {
		...
		packer.packExtensionTypeHeader((byte) 1, 10); // type number [0, 127],
														// data byte length
	...
	public static void configuration() throws IOException {
		...
		// If your data contains many large strings (the default is 8k)
		MessageUnpacker unpacker = new UnpackerConfig().withStringDecoderBufferSize(16 * 1024).newUnpacker(packedData);
