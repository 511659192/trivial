...
public class Orika_PersonDto_Person_Mapper305777469248767$0 extends ma.glasnost.orika.impl.GeneratedMapperBase {
    public void mapAtoB(java.lang.Object a, java.lang.Object b,
        ...
        if (!(((java.util.List) source.getNames()) == null)) {
            ...
            while (names_$_iter.hasNext()) {
                ...
                if ((personalNames_destination0Element == null) ||
                        !((((((java.lang.String) names_source0Element.getFullName()) != null) &&
                                ((java.lang.String) names_source0Element.getFullName()).equals(
                                        ((java.lang.String) personalNames_destination0Element.getKey()))))) ||
                        !((((com.ym.orika.Name) names_source0Element).equals(
                                ((com.ym.orika.Name) personalNames_destination0Element.getValue()))))) {
                    personalNames_destination0Element = ((ma.glasnost.orika.MapEntry) ((ma.glasnost.orika.BoundMapperFacade) usedMapperFacades[0]).newObject(names_source0Element,
                            mappingContext));
                    personalNames_destination0ElementShouldBeAddedToCollector = true;
                }

                mappingContext.beginMapping(((ma.glasnost.orika.metadata.Type) usedTypes[0]),
                        ((java.util.List) source.getNames()),
                        ((ma.glasnost.orika.metadata.Type) usedTypes[1]),
                        new_destinationPersonalNames0);
                ...
                try {
                    ...
                    if (!(((com.ym.orika.Name) names_source0Element) == null)) {
                        if (((com.ym.orika.Name) personalNames_destination0Element.getValue()) == null) {
                            personalNames_destination0Element.setValue((com.ym.orika.Name) ((ma.glasnost.orika.BoundMapperFacade) usedMapperFacades[1]).map(
                                    ((com.ym.orika.Name) names_source0Element),
                                    mappingContext));
                        } else {
                            personalNames_destination0Element.setValue((com.ym.orika.Name) ((ma.glasnost.orika.BoundMapperFacade) usedMapperFacades[1]).map(
                                    ((com.ym.orika.Name) names_source0Element),
        ...
        if (!(new_destinationPersonalNames0 == null) &&
                !new_destinationPersonalNames0.isEmpty()) {
            ...
            listToMap(new_destinationPersonalNames0,
                    ((java.util.Map) destination.getPersonalNames()));
        }
    ...
    public void mapBtoA(java.lang.Object a, java.lang.Object b,
        ...
        boolean names_destination0ElementShouldBeAddedToCollector = false;

        if (!(((java.util.Map) source.getPersonalNames()) == null)) {
            java.util.Iterator personalNames_$_iter = ((java.util.Map) source
                    .getPersonalNames()).entrySet()
                    .iterator();
            ...
            while (personalNames_$_iter.hasNext()) {
                ...
                if ((names_destination0Element == null) ||
                        !((((((java.lang.String) personalNames_source0Element.getKey()) != null) &&
                                ((java.lang.String) personalNames_source0Element.getKey()).equals(
                                        ((java.lang.String) names_destination0Element.getFullName()))))) ||
                        !((((com.ym.orika.Name) personalNames_source0Element.getValue()).equals(
                                ((com.ym.orika.Name) names_destination0Element))))) {
                    names_destination0Element = ((com.ym.orika.Name) ((ma.glasnost.orika.BoundMapperFacade) usedMapperFacades[2]).newObject(personalNames_source0Element,
                            mappingContext));
                    names_destination0ElementShouldBeAddedToCollector = true;
                }

                mappingContext.beginMapping(((ma.glasnost.orika.metadata.Type) usedTypes[2]),
                        ((java.util.Map) source.getPersonalNames()),
                        ((ma.glasnost.orika.metadata.Type) usedTypes[0]),
                        new_destinationNames0);
                ...
                try {
                    ...
                    if (!(((com.ym.orika.Name) personalNames_source0Element.getValue()) == null)) {
                        if (((com.ym.orika.Name) names_destination0Element) == null) {
                            names_destination0Element = (com.ym.orika.Name) ((ma.glasnost.orika.BoundMapperFacade) usedMapperFacades[1]).map(((com.ym.orika.Name) personalNames_source0Element.getValue()),
                                    mappingContext);
                        } else {
                            names_destination0Element = (com.ym.orika.Name) ((ma.glasnost.orika.BoundMapperFacade) usedMapperFacades[1]).map(((com.ym.orika.Name) personalNames_source0Element.getValue()),
                                    ((com.ym.orika.Name) names_destination0Element),
                        ...
                        names_destination0Element = null;
                    }
                } finally {
                    mappingContext.endMapping();
                }
        ...
        if (!(new_destinationNames0 == null) &&
                !new_destinationNames0.isEmpty()) {
